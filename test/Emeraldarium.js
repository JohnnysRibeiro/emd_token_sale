...
contract('Emeraldarium', function(accounts) {
  ...
  it('approves tokens for delegated transfer', function(){
    return Emeraldarium.deployed().then(function(instance){
      ...
      assert.equal(receipt.logs[0].args._owner, accounts[0], 'logs the account the tokens are being approved from');
      assert.equal(receipt.logs[0].args._spender, accounts[1], 'logs the account the tokens are being approved to');
